...
module.exports = {
    ...
    pledgePDF: async (req, res, db, MongoClient, transporter, protocol, hostname, port) => {
        ...
        <html>
            ...
            <body>
                <div class="show_frame" style="width: 100%;float: left;border: 1px solid #000; box-sizing: border-box; padding: 20px 0px;height: 100%;">
                    <div class="details_page" style="width: 500px;max-width:100%;margin:0 auto; background-color: #fff;">
                        ...
                        transporter.sendMail({
                            ...
                            if (err) {
                                ...
                                if (info) {
                                    ...
                                    var seq = Math.floor(Math.random() * 90000) + 10000;
